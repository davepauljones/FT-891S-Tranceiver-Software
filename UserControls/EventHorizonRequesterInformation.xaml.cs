...
{
    /// <summary>
    /// Interaction logic for EventHorizonRequesterInformation.xaml
    /// </summary>
    public partial class EventHorizonRequesterInformation : Window
    {
        MainWindow mw;
        ...
        public EventHorizonRequesterInformation(MainWindow mw, OracleCustomMessage oracleCustomMessage, int requesterType, bool overrideNotificationSound = true)
        {
            InitializeComponent();
            this.Hide();
